#ifndef AI_PLATFORM_FACE_DETECT_SDK_H
#define AI_PLATFORM_FACE_DETECT_SDK_H
...
using FaceDetectSdkResult = CapabilitySdkResult;
...
public:
    ...
    FaceDetectSdkResult infer_image_base64(const std::string& image_base64, const std::string& image_format) const;
