...
std::string prepare_license(const std::string& capability_id) {
    ...
    data.license_id = "LIC-SDK-003";
    data.version = "1.0";
    data.license_type = "development";
    data.customer_id = "CUST-SDK-003";
...
std::string prepare_denied_license(const std::string& capability_id) {
    ...
    ai_platform::LicenseFileData data;
    data.license_id = "LIC-SDK-003-DENIED";
    data.version = "1.0";
    data.license_type = "development";
    data.customer_id = "CUST-SDK-003";
    data.customer_name = "demo_customer";
...
int main(int argc, char** argv) {
    assert_true(argc >= 3, "usage: test_idcard_detect_sdk <plugin_path> <model_dir>");
    ...
    assert_true(sdk.capability_id() == "idcard_detect", "sdk capability id should be idcard_detect");
    ...
    assert_true(infer_result.result_json.find("\"side\":\"front\"") != std::string::npos, "sdk infer result should contain idcard side field");

    ai_platform::IdCardDetectSdk denied_sdk;
    const auto denied_license_path = prepare_denied_license("idcard_detect");
    ...
    assert_true(denied_sdk.last_license_failure_detail() == "idcard_detect", "sdk denied failure detail accessor should expose capability id");
